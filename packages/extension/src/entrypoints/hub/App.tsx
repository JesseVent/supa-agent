		...
		<div className="flex h-screen bg-background">
			...
			<aside className="w-80 shrink-0 border-r flex flex-col bg-muted/20">
				...
				>
					...
					<span className="text-sm font-semibold tracking-tight">SupaAgent Hub</span>
					<span className="text-[9px] font-medium uppercase tracking-wider text-primary bg-primary/10 border border-primary/30 rounded px-1.5 py-0.5">
						Beta
					</span>
				</a>
