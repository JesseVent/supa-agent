...
export default function HeroSection() {
	const { language } = useLanguage()
		...
		const defaultTask = 'Goto docs in navigation bar, find Quick-Start section, and summarize in markdown'
				...
				<div className="relative z-10">
						...
						<div className="max-w-3xl mx-auto">
							...
							>
								...
								<div className="flex border-b border-gray-200 dark:border-gray-700">
									...
									>
										{false ? '🌐 其他网页尝试' : '🌐 Try on Other Sites'}
									</button>
								</div>
											...
											<p className="text-xs text-gray-500 dark:text-gray-400 text-left">
												{false ? (
													<>
														...
														<a
															href="https://supabase.com/docs/terms"
															target="_blank"
										...
										<div className="grid md:grid-cols-2 gap-6">
											...
											<div className="space-y-4">
												<div className="bg-blue-50 dark:bg-gray-700 p-4 rounded-lg">
													<p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
														<span className="font-semibold">{false ? '步骤 1:' : 'Step 1:'}</span>{' '}
														{false ? '显示收藏夹栏' : 'Show your bookmarks bar'}
													</p>
												...
												<div className="bg-green-50 dark:bg-gray-700 p-4 rounded-lg">
													<p className="text-gray-700 dark:text-gray-300 text-sm mb-3">
														<span className="font-semibold">{false ? '步骤 2:' : 'Step 2:'}</span>{' '}
														{false ? '拖拽下面按钮到收藏夹栏' : 'Drag this button to your bookmarks'}
													</p>
												...
												<div className="bg-purple-50 dark:bg-gray-700 p-4 rounded-lg">
													<p className="text-gray-700 dark:text-gray-300 text-sm">
														<span className="font-semibold">{false ? '步骤 3:' : 'Step 3:'}</span>{' '}
														{false
															? '在其他网站点击收藏夹中的按钮即可使用'
											...
											<div className="bg-yellow-50 dark:bg-gray-700 p-4 rounded-lg">
												...
												<ul className="space-y-2 text-sm text-gray-700 dark:text-gray-300">
													...
													<li className="flex items-start text-left">
														<span className="w-1.5 h-1.5 bg-yellow-500 rounded-full mt-2 mr-2 shrink-0 "></span>
														{false ? '支持单页应用' : 'Works on single-page apps'}
													</li>
													<li className="flex items-start text-left">
														<span className="w-1.5 h-1.5 bg-yellow-500 rounded-full mt-2 mr-2 shrink-0 "></span>
														{false
													...
													<li className="flex items-start text-left">
														<span className="w-1.5 h-1.5 bg-yellow-500 rounded-full mt-2 mr-2 shrink-0 "></span>
														{false ? '详细使用限制参照' : 'Full limitations in'}
														<Link
					...
					>
						<li className="flex items-center">
							...
							{false ? '纯前端方案' : 'Pure Front-end Solution'}
						</li>
						<li className="flex items-center">
							<span className="w-2 h-2 bg-green-500 rounded-full mr-2" aria-hidden="true"></span>
							{false ? '支持私有模型' : 'Your Own Models'}
						</li>
						<li className="flex items-center">
							<span className="w-2 h-2 bg-green-500 rounded-full mr-2" aria-hidden="true"></span>
							{false ? '无痛脱敏' : 'Built-in Privacy'}
						</li>
						<li className="flex items-center">
							<span className="w-2 h-2 bg-green-500 rounded-full mr-2" aria-hidden="true"></span>
							{false ? 'MIT 开源' : 'MIT Open Source'}
						</li>
					</ul>
				</div>
			</div>
