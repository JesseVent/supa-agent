...
const LLM_CLOUD: {
	...
	{ name: 'Gemini', color: '#3b82f6', x: 35, y: 50, size: 1.8, opacity: 0.9 },
	{ name: 'DeepSeek', color: '#06b6d4', x: 72, y: 48, size: 1.2, opacity: 0.85 },
						...
						>
							<div className={`flex ${CARD_HEIGHT} flex-col`}>
								...
								<div className="px-7 pb-5">
									...
									<p className="text-sm text-gray-500 dark:text-gray-300 leading-relaxed">
										{isZh
											? 'OpenAI、Claude、DeepSeek、Gemini 等，或通过 Ollama 完全离线。'
											: 'OpenAI, Claude, DeepSeek, Gemini, and more — or fully offline via Ollama.'}
									</p>
								</div>
							</div>
						</MagicCard>
