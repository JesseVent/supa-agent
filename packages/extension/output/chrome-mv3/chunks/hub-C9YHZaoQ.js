...
var HubWs = class {
	...
	async #checkApproval() {
		...
		const ok = window.confirm(
			'An external application is requesting to control your browser via SupaAgent.\nAllow this session?'
		)
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('a', {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
								...
								children: 'SupaAgent Hub',
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
								className:
									'text-[9px] font-medium uppercase tracking-wider text-primary bg-primary/10 border border-primary/30 rounded px-1.5 py-0.5',
								children: 'Beta',
							}),
						],
					}),
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
										children:
											'SupaAgent Hub lets local apps (e.g. MCP servers) control the SupaAgent extension via WebSocket.',
									}),
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('header', {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(WsIcon, { className: 'size-3.5' }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', { children: wsLabel }),
								],
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
				...
				children: [
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('label', {
						className: `flex items-center justify-between p-3 rounded-md border cursor-pointer text-xs ${allowAll ? 'bg-primary/10 border-primary/30 text-primary' : 'bg-muted/50 text-muted-foreground'}`,
						children: [
							'Auto-approve connections',
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Switch, {
								checked: allowAll,
								onCheckedChange: toggle,
								className: allowAll ? 'data-[state=checked]:bg-primary' : '',
							}),
						],
					}),
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
