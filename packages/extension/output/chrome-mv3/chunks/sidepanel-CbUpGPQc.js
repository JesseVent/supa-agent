...
function ConfigPanel({ config, onSave, onClose }) {
	...
	const [model, setModel] = (0, import_react.useState)(config?.model || 'google/gemini-2.5-flash')
	...
	const [experimentalLlmsTxt, setExperimentalLlmsTxt] = (0, import_react.useState)(
		config?.experimentalLlmsTxt ?? false
	)
	const [experimentalIncludeAllTabs, setExperimentalIncludeAllTabs] = (0, import_react.useState)(
		config?.experimentalIncludeAllTabs ?? false
	)
	const [disableNamedToolChoice, setDisableNamedToolChoice] = (0, import_react.useState)(
		config?.disableNamedToolChoice ?? false
	)
	const [skillRouterUrl, setSkillRouterUrl] = (0, import_react.useState)(
		config?.skillRouterUrl ?? ''
	)
	const [skillRouterKey, setSkillRouterKey] = (0, import_react.useState)(
		config?.skillRouterKey ?? ''
	)
	const [skillRouterSkill, setSkillRouterSkill] = (0, import_react.useState)(
		config?.skillRouterSkill ?? ''
	)
	const [supabaseMcpProjectRef, setSupabaseMcpProjectRef] = (0, import_react.useState)(
		config?.supabaseMcpProjectRef ?? ''
	)
	const [supabaseMcpAccessToken, setSupabaseMcpAccessToken] = (0, import_react.useState)(
		config?.supabaseMcpAccessToken ?? ''
	)
	const [showSupabaseToken, setShowSupabaseToken] = (0, import_react.useState)(false)
	...
	;(0, import_react.useEffect)(() => {
		...
		const fetchToken = async () => {
			const token = (await chrome.storage.local.get('PageAgentExtUserAuthToken'))
	...
	const handleSave = async () => {
		...
		try {
			await onSave({
				...
				skillRouterUrl: skillRouterUrl || void 0,
				skillRouterKey: skillRouterKey || void 0,
				skillRouterSkill: skillRouterSkill || void 0,
				supabaseMcpProjectRef: supabaseMcpProjectRef || void 0,
				supabaseMcpAccessToken: supabaseMcpAccessToken || void 0,
			})
		} finally {
			setSaving(false)
		}
	...
	return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
		...
		children: [
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						'aria-label': 'Back',
						children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(CornerUpLeft, {
							className: 'size-3.5',
						}),
					}),
				],
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
								...
								children: showToken
									? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(EyeOff, { className: 'size-3' })
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('a', {
				...
				className:
					'flex items-center justify-between p-3 rounded-md border bg-muted/50 text-xs font-medium text-muted-foreground hover:text-foreground hover:border-primary/40 transition-colors',
				children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('button', {
				...
				children: [
					'Advanced',
					advancedOpen
						? /* @__PURE__ */ (0, import_jsx_runtime.jsx)(FoldVertical, { className: 'size-3' })
						: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(UnfoldVertical, { className: 'size-3' }),
				],
			}),
			advancedOpen &&
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
									className: 'text-xs font-medium text-muted-foreground',
									children: 'Supabase MCP',
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)('p', {
									className: 'text-[10px] text-muted-foreground',
									children: 'Lets the agent query your Supabase project from any page.',
								}),
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Input, {
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
				...
				children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Button, {
						...
						disabled: saving,
						className:
							'flex-1 h-8 text-xs cursor-pointer rounded-full bg-gradient-to-r from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white border-0 shadow-[0_0_16px_rgba(139,92,246,0.25)]',
						children: saving
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
						...
						children: [
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('a', {
								...
								className: 'flex items-center gap-1 hover:text-foreground',
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(House, { className: 'size-3' }),
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', { children: 'Supabase' }),
								],
							}),
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('a', {
								...
								className: 'flex items-center gap-1 hover:text-foreground',
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(HatGlasses, { className: 'size-3' }),
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)('span', {
					...
					children: [
						'Powered by ',
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)('span', {
							className: 'text-[#3ECF8E] font-medium',
							children: 'Supabase',
						}),
					],
				}),
...
//#endregion
//#region ../../node_modules/.bun/idb@8.0.3/node_modules/idb/build/index.js
		...
		children: [
					...
					/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
						...
						children: [
							...
							/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('button', {
								...
								children: [
									/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: 'size-3' }),
									'Delete',
								],
							}),
						],
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
				...
				children: session.history.map((event, index) =>
					/* @__PURE__ */ (0, import_jsx_runtime.jsx)(EventCard, { event }, index)
				),
			}),
		],
	})
...
var EXPORT_FILE_PREFIX = 'supa-agent-history'
				...
				children: [
					...
					sessions.length > 0 &&
						/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(Button, {
							...
							children: [
								/* @__PURE__ */ (0, import_jsx_runtime.jsx)(Trash2, { className: 'size-3 mr-1' }),
								'Clear All',
							],
						}),
				],
							...
							children: [...Array(4)].map((_, i) =>
								/* @__PURE__ */ (0, import_jsx_runtime.jsxs)(
									'div',
									{
										...
										children: [
											/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
												className: 'size-3.5 mt-0.5 rounded-full bg-muted animate-pulse shrink-0',
											}),
											/* @__PURE__ */ (0, import_jsx_runtime.jsxs)('div', {
												className: 'flex-1 space-y-1.5',
												children: [
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
														className: 'h-2.5 bg-muted animate-pulse rounded w-3/4',
													}),
													/* @__PURE__ */ (0, import_jsx_runtime.jsx)('div', {
														className: 'h-2 bg-muted animate-pulse rounded w-1/3',
													}),
												],
											}),
										],
		...
		children: [
			...
			/* @__PURE__ */ (0, import_jsx_runtime.jsx)('footer', {
				...
				children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)(InputGroup, {
					...
					children: [
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputGroupTextarea, {
							ref: textareaRef,
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputGroupAddon, {
							...
							children: isRunning
								...
								: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(InputGroupButton, {
										...
										className:
											'size-7 cursor-pointer rounded-full bg-gradient-to-br from-violet-500 to-cyan-500 hover:from-violet-400 hover:to-cyan-400 text-white border-0 disabled:opacity-40 shadow-[0_0_12px_rgba(139,92,246,0.3)]',
										'aria-label': 'Send',
										title: 'Send',
