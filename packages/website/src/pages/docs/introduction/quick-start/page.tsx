				...
				<div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
					...
					<div className="bg-yellow-50 dark:bg-yellow-900/20 p-2 rounded mb-3 text-sm">
						<span className="text-yellow-800 dark:text-yellow-200">
							...
							{isZh ? (
								<>
									该 Demo CDN 使用了 OpenRouter API，使用即表示您同意其
									<a
								...
								<>
									This demo CDN uses OpenRouter API. By using it you agree to the{' '}
									<a
										href="https://supabase.com/docs/terms"
										target="_blank"
										rel="noopener noreferrer"
					...
					<table className="w-full border-collapse text-sm">
						...
						<tbody>
							<tr className="border-b border-gray-100 dark:border-gray-800">
								...
								<td className="py-2 px-3 font-mono text-xs break-all">{"https://cdn.jsdelivr.net/npm/page-agent@1.8.2/dist/iife/page-agent.demo.js"}</td>
							</tr>
							<tr>
