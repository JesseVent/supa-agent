...
export default function ChromeExtension() {
	...
	const githubReleasesUrl = 'https://github.com/supabase/supabase/releases'
				...
				<section>
					...
					<section className="p-4 bg-purple-50 dark:bg-purple-900/20 rounded-lg">
						...
						<div className="space-y-2">
							<a
								href="https://github.com/supabase/supabase/blob/main/packages/extension/docs/extension_api.md"
								target="_blank"
								rel="noopener noreferrer"
...
window.PAGE_AGENT_EXT.stop()`
				...
				<section>
					...
					<p className="text-gray-600 dark:text-gray-300 mb-4">
						...
						<a
							href="https://github.com/supabase/supabase/blob/main/packages/extension/src/entrypoints/background.ts"
							target="_blank"
							rel="noopener noreferrer"
