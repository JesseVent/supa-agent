...
"We" in this document refers to the maintainers of the open-source SupaAgent project (https://github.com/JesseVent/supa-agent). "The software" refers to SupaAgent (the JavaScript library) and SupaAgentExt (the browser extension). This document covers the software itself and the testing API we provide — **not** any third-party product or service built with it.
...
The project is open source under the [MIT License](https://github.com/JesseVent/supa-agent/blob/main/LICENSE) and can be audited at: https://github.com/JesseVent/supa-agent
...
## 3. Browser Extension (SupaAgentExt)
...
https://github.com/JesseVent/supa-agent/issues
